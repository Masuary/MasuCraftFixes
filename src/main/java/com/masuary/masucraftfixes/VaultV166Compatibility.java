...
public final class VaultV166Compatibility {
    ...
    public static final String TARGET_VAULT_VERSION = "1.18.2-20.0.3-remastered.6872";
    ...
    public static void installIfConfigured() {
        if (!MasuCraftFixesConfig.ENABLE_LEGACY_V166_VAULT_DATA_COMPATIBILITY.get()) {
            MasuCraftFixes.LOGGER.info("Legacy Vault build 6574 v1_66 compatibility is disabled");
            return;
        }
        ...
        if (!TARGET_VAULT_VERSION.equals(installedVaultVersion)) {
            MasuCraftFixes.LOGGER.info(
                    "Legacy Vault build 6574 v1_66 compatibility skipped for Vault version '{}'; expected '{}'",
        ...
        try {
            ...
            MasuCraftFixes.LOGGER.warn(
                    "Installed the temporary Vault build 6574 v1_66 schema reader for "
